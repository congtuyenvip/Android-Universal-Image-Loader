...
import com.ctvip.uil.cache.disc.naming.FileNameGenerator;
import com.ctvip.uil.cache.memory.MemoryCache;
import com.ctvip.uil.cache.memory.impl.FuzzyKeyMemoryCache;
...
import com.ctvip.uil.core.process.BitmapProcessor;
...
public final class ImageLoaderConfiguration {
	...
	private ImageLoaderConfiguration(final Builder builder) {
		...
		Logger.writeDebugLogs(builder.writeLogs);
	}
	...
	public static class Builder {
		...
		public Builder taskExecutor(Executor executor) {
			if (threadPoolSize != DEFAULT_THREAD_POOL_SIZE || threadPriority != DEFAULT_THREAD_PRIORITY || tasksProcessingType != DEFAULT_TASK_PROCESSING_TYPE) {
				Logger.w(WARNING_OVERLAP_EXECUTOR);
			}
		...
		public Builder memoryCacheSize(int memoryCacheSize) throws Exception  {
			...
			if (memoryCache != null) {
				Logger.w(WARNING_OVERLAP_MEMORY_CACHE);
		...
		public Builder diskCacheSize(int maxCacheSize) {
			...
			if (diskCache != null) {
				Logger.w(WARNING_OVERLAP_DISK_CACHE_PARAMS);
			}
		...
		public Builder diskCacheFileNameGenerator(FileNameGenerator fileNameGenerator) {
			if (diskCache != null) {
				Logger.w(WARNING_OVERLAP_DISK_CACHE_NAME_GENERATOR);
			}

...
import com.ctvip.uil.cache.disc.DiskCache;
import com.ctvip.uil.cache.memory.MemoryCache;
import com.ctvip.uil.core.assist.FailReason;
import com.ctvip.uil.core.assist.FlushedInputStream;
...
import com.ctvip.uil.core.imageaware.ImageViewAware;
import com.ctvip.uil.core.imageaware.NonViewAware;
import com.ctvip.uil.core.listener.ImageLoadingListener;
import com.ctvip.uil.core.listener.ImageLoadingProgressListener;
import com.ctvip.uil.core.listener.SimpleImageLoadingListener;
import com.ctvip.uil.utils.ImageSizeUtils;
import com.ctvip.uil.utils.Logger;
import com.ctvip.uil.utils.MemoryCacheUtils;
...
public class ImageLoader {
	...
	public synchronized void init(ImageLoaderConfiguration configuration) {
		...
		if (this.configuration == null) {
			Logger.d(LOG_INIT_CONFIG);
			engine = new ImageLoaderEngine(configuration);
			this.configuration = configuration;
		} else {
			Logger.w(WARNING_RE_INIT_CONFIG);
		}
	}
	 ...
	 * @param imageAware {@linkplain com.nostra13.uil.core.imageaware.ImageAware Image aware view}
	 ...
	 * @param imageAware {@linkplain com.nostra13.uil.core.imageaware.ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain com.nostra13.uil.core.DisplayImageOptions Options} for image
	 ...
	 * @param progressListener {@linkplain com.nostra13.uil.core.listener.ImageLoadingProgressListener
	 *                         Listener} for image loading progress. Listener fires events on UI thread if this method
	 *                         is called on UI thread. Caching on disk should be enabled in
	 *                         {@linkplain com.nostra13.uil.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	 ...
	 * {@link com.nostra13.uil.core.imageaware.ImageAware ImageAware}
	 */
	 ...
	 * {@link com.nostra13.uil.core.imageaware.ImageAware ImageAware}.
	 *
	 * @param imageAware {@link com.nostra13.uil.core.imageaware.ImageAware ImageAware} for
	 ...
	 */
	public void destroy() {
		if (configuration != null) Logger.d(LOG_DESTROY);
		stop();

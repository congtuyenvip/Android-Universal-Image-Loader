 ...
 *******************************************************************************/
package com.ctvip.uil.sample.ext;
...
public class OldRoundedBitmapDisplayer implements BitmapDisplayer {
	...
	public static Bitmap roundCorners(Bitmap bitmap, ImageViewAware imageAware, int roundPixels) {
		...
		if (imageView == null) {
			Logger.w("View is collected probably. Can't round bitmap corners without view properties.");
			return bitmap;
		}
		...
		try {
			...
			Logger.e(e, "Can't create bitmap with rounded corners. Not enough memory.");
			roundBitmap = bitmap;
		}
